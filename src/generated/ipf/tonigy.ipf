...
:h1.About Tonigy
.br
:hp2.Tonigy v1.7. Audio/Video/Data CD IFS for OS/2. Multimedia CD System.:ehp2.
:p.Tonigy is an Audio/Video/Data CD IFS for OS/2 that maps tracks of Audio CD into
WAV or RAW files, tracks of Video CD into MPG files and tracks of Data CD into
ISO files. Use it for accessing audio, video and data tracks like ordinary
files. Also Tonigy allows to access files of CD-I disks and the boot image of
ISO tracks.
:p.Main features&colon.
:ul compact.
:li.IFS for OS/2
:li.represents :hp2.audio:ehp2. tracks as :hp2.WAV:ehp2. or :hp2.RAW:ehp2. files
:li.represents :hp2.video:ehp2. tracks as :hp2.MPG:ehp2. files
:li.represents :hp2.data:ehp2. tracks as :hp2.ISO:ehp2. files
:li.allows to access :hp2.CD-I:ehp2. files
:li.allows to access :hp2.boot image:ehp2. of an :hp2.ISO:ehp2. track
:li.easy control and setup by PM GUI panel
:li.English/German/Russian interface
:li.supports extended attributes (reading/writing)
:li.supports adaptive Anti-Jittering for reading audio sectors
:li."Highest Priority" option for slow CD-ROM drives and PCs
...
:li.Push the OK button to close the Setup dialog.
...
:ul compact.
:li.:link reftype=hd res=3.Setup Drive:elink. page or pages
:li.:link reftype=hd res=4.General:elink. page
:eul.
:h2 res=3.
Setup Drive page
:p.
...
:dt.:link reftype=fn refid=NEW.NEW:elink.&colon. 
:dd.The BLOCKS.RAW directory
:dt.:link reftype=fn refid=NEW.NEW:elink.&colon. 
:dd.The pop-up menu in the main window
:dt.:link reftype=fn refid=NEW.NEW:elink.&colon. 
:dd.The "General Option" dialog
:dt.:link reftype=fn refid=NEW.NEW:elink.&colon. 
:dd.The "Highest Priority" option
:dt.:link reftype=fn refid=NEW.NEW:elink.&colon. 
:dd.German interface and documentation
:dt.:link reftype=fn refid=NEW.NEW:elink.&colon. 
:dd.The ability to select the first letter of CD-ROM drives
:dt.:link reftype=fn refid=NEW.NEW:elink.&colon. 
:dd.Logging warning and error messages into a virtual file on a Tonigy disk
:dt.:link reftype=fn refid=NEW.NEW:elink.&colon. 
:dd.Online help (English and German)
:dt.:link reftype=fn refid=NEW.NEW:elink.&colon. 
:dd.The named pipe to control Tonigy
:dt.:link reftype=fn refid=CHG.CHG:elink.&colon. 
:dd.The background color of the main window was changed to pale gray
:dt.:link reftype=fn refid=CHG.CHG:elink.&colon. 
:dd.The new method of Jitter detection
:dt.:link reftype=fn refid=CHG.CHG:elink.&colon. 
:dd.The README file was renamed to README.TXT
:dt.:link reftype=fn refid=CHG.CHG:elink.&colon. 
:dd.The RAW directory was renamed to TRACKS.RAW
:dt.:link reftype=fn refid=CHG.CHG:elink.&colon. 
:dd.The Tonigy web site URL and the support E-Mail was changed
:dt.:link reftype=fn refid=CHG.CHG:elink.&colon. 
:dd.Minor changes
:edl.
:h2.Version 1.2
...
:dl compact.
:dt.:link reftype=fn refid=NEW.NEW:elink.&colon. 
:dd.Mapping data/iso tracks into ISO files
:dt.:link reftype=fn refid=NEW.NEW:elink.&colon. 
:dd.The FILES.CDI directory with files of a CD-I disk
:dt.:link reftype=fn refid=CHG.CHG:elink.&colon. 
:dd.The interface of the main window was changed
:dt.:link reftype=fn refid=CHG.CHG:elink.&colon. 
:dd.The Setup Drive and General Options windows was merged
:dt.:link reftype=fn refid=CHG.CHG:elink.&colon. 
:dd.Minor changes
:edl.
:h2.Version 1.4
:dl compact.
:dt.:link reftype=fn refid=NEW.NEW:elink.&colon. 
:dd.The BOOT.IMG directory with the boot image of the first ISO track
:dt.:link reftype=fn refid=CHG.CHG:elink.&colon. 
:dd.The method of track type determination was improved
:dt.:link reftype=fn refid=FIX.FIX:elink.&colon. 
:dd.Wrong size of ISO images
:dt.:link reftype=fn refid=FIX.FIX:elink.&colon. 
:dd.Possible lockup of system due to wrong determination of track type
:edl.
:h2.Version 1.5
:dl compact.
:dt.:link reftype=fn refid=NEW.NEW:elink.&colon. 
:dd.The WarpIN package is available
:dt.:link reftype=fn refid=NEW.NEW:elink.&colon. 
:dd.The URL object was added into the Tonigy Folder
:dt.:link reftype=fn refid=FIX.FIX:elink.&colon. 
:dd.Wrong return code from FS_FILEATTRIBUTE
:dt.:link reftype=fn refid=FIX.FIX:elink.&colon. 
:dd.Sometimes wrong info about jitter presence in CDINFO.TXT
:dt.:link reftype=fn refid=FIX.FIX:elink.&colon. 
:dd.Wrong size of boot image if emulated media is not floppy disk
:dt.:link reftype=fn refid=FIX.FIX:elink.&colon. 
:dd.INSTALL.CMD add invalid IFS= statement if full path contains space(s)
:edl.
:h2.Version 1.6
:dl compact.
:dt.:link reftype=fn refid=NEW.NEW:elink.&colon. 
:dd.The TRACKS.WAV directory with audio tracks
:dt.:link reftype=fn refid=CHG.CHG:elink.&colon. 
:dd.Directories will not be shown if they are empty
:dt.:link reftype=fn refid=NEW.NEW:elink.&colon. 
:dd.Russian interface and messages
:edl.
:h2.Version 1.7
:dl compact.
:dt.:link reftype=fn refid=NEW.NEW:elink.&colon. 
:dd.Abitily to eject CD (see the pop-up menu)
:dt.:link reftype=fn refid=CHG.CHG:elink.&colon. 
:dd.Appended drive letters to pop-up menu's items (Attach, Detach)
:edl.
:h1.License Information
:hp2.:p.NOTICE TO USERS&colon. CAREFULLY READ THE FOLLOWING LEGAL AGREEMENT. USE OF THE
...
CONDITIONED UPON COMPLIANCE BY USER WITH THE TERMS OF THIS AGREEMENT.:ehp2.
:p.:hp2.LICENSE GRANT:ehp2.. DEF Group grants you a license to use one copy of
this SOFTWARE on any one hardware product for as many licenses as you purchase.
...
:hp2.:p.NO OTHER WARRANTIES. DEF GROUP DOES NOT WARRANT THAT THE SOFTWARE IS ERROR
...
JURISDICTION TO JURISDICTION.:ehp2.
:h1.Registration
:p.The registration fee is 20 US Dollars. Once registered you remain a registered
user for all future Tonigy versions.
:p.For registration or additional information, please visit the ":hp2.Register
Now!:ehp2." section of the Tonigy site (http&colon.//www.tonigy.com).
:h1.Support and Feedback
:p.Send questions, bug reports and suggestions to :hp4.tonigy@defgroup.com:ehp4.
.br
Visit the Tonigy site: :hp4.http&colon.//www.tonigy.com:ehp4.
:euserdoc.
